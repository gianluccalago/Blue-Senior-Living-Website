...
const posts = [
  {
    ...
    content: [
      { type: "p", text: `Poucas decisões pesam tanto quanto essa. Reconhecer que cuidar de um pai ou de uma mãe em casa ficou difícil não é admitir derrota — é um gesto de amor e de responsabilidade. Ainda assim, a dúvida quase sempre vem acompanhada de culpa e da mesma pergunta: “será que já é hora?”.` },
      { type: "p", text: `Não existe uma data certa. Mas existem sinais. Observados com carinho e honestidade, eles ajudam a família a decidir no tempo certo — antes de uma crise, e não depois dela.` },
      ...
      { type: "p", text: `Escolher um residencial não é abrir mão de cuidar. É escolher que seu pai ou sua mãe seja cuidado por uma equipe inteira, o tempo todo, com recursos que uma casa não comporta. A culpa costuma vir do mito de que “cuidar de verdade” é cuidar sozinho. Não é. Cuidar de verdade é garantir o melhor cuidado possível.` },
  ...
  },
  {
    ...
    author: "Equipe Blue Senior Living",
    content: [
      { type: "p", text: `A melhor forma de escolher um residencial é visitando. Fotos encantam, textos convencem — mas é no lugar, sentindo o ambiente e olhando nos olhos de quem cuida, que a verdade aparece. Para ajudar, reunimos o que realmente importa observar.` },
      ...
      { type: "p", text: `Leve suas perguntas por escrito, visite mais de uma vez se puder e em horários diferentes. No fim, alguns dados são objetivos — mas a sensação também conta. Você consegue se imaginar deixando quem ama ali, tranquilo? Essa resposta, sentida no lugar, costuma ser a mais sábia de todas.` },
    ],
  },
  {
